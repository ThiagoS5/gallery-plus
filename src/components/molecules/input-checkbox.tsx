...
export const inputCheckboxVariants = tv({
  ...
  variants: {
    variant: {
      ...
      hover:border-border-active bg-transparent rounded
...
export const inputCheckboxIconVariantes = tv({
  ...
  return (
    <label className={inputCheckboxWrapperVariants({ className, disabled })}>
      <input
        ...
        {...props}
      />
      <Icon svg={CheckIcon} className={inputCheckboxIconVariantes({ size })} />
    </label>
  );
}
